...
// local.properties (git-ignored) overrides gradle.properties so secrets never land in VCS.
...
android {
    namespace = "com.ehs.tbttracker"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.ehs.tbttracker"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"

        testInstrumentationRunner = "com.ehs.tbttracker.HiltTestRunner"
        vectorDrawables { useSupportLibrary = true }

        buildConfigField("String", "WEB_APP_URL", "\"${backendProp("EHS_WEB_APP_URL")}\"")
        buildConfigField("String", "API_TOKEN", "\"${backendProp("EHS_API_TOKEN")}\"")
    }
...
dependencies {
    ...
    // Images, camera, location, permissions
